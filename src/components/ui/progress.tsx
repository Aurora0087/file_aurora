...
// Create a custom type that extends the primitive props to include indicatorClassName
...
function Progress({
  ...
  children,
  value,
  indicatorClassName, // Add the new prop here
  ...props
}: ProgressProps) {
  return (
    ...
    >
      {children}
      <ProgressTrack>
        {/* Pass the indicatorClassName down to the indicator */}
